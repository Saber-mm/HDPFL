...
def get_dataset_even_odd_split(dataset='MNIST', num_users=20, num_even_users=10, p_even=1, iidness=True, unequal=False, user_max_class=10):
    """ Returns train and test datasets and a user group which is a dict where
    the keys are the user index and the values are the corresponding data for
    each of those users.
    """
    ...
    if dataset == 'CIFAR10':
        ...
        user_groups = iid_even_odd(train_dataset, num_users, num_even_users, p_even)
